...
#
df = pd.read_csv('C:\Data\Projektit\DAT210x\Module5\Datasets\Crimes_-_2001_to_present.csv')
#
...
#
# df[['Date']].dtypes .. no need to coerce. otherways pandas.to_datetime() would be needed
